...
- [**Lovable**](https://lovable.dev/) – AI pair programmer that helps you rapidly build and deploy full-stack apps.
- [**ChatGPT (OpenAI)**](https://chat.openai.com/) – Great for brainstorming, debugging, writing explanations, and improving documentation.
- **Claude (Anthropic)** – Excellent for refining text, structuring ideas, and reviewing project summaries.
- [**Google Gemini**](https://gemini.google.com/) – Helpful for quick code generation, technical research, and idea validation.
- [**Perplexity AI**](https://www.perplexity.ai/) – AI-powered search tool for real-time information and research support.
- [**Hugging Face**](https://huggingface.co/models) – Access open-source models for NLP, computer vision, and ML.
- [**GitHub Copilot**](https://github.com/features/copilot) – AI assistant in VS Code that accelerates coding and debugging.

---

## 💻 Development Platforms

- [**Google Colab**](https://colab.research.google.com/) – Cloud-based Python environment for data analysis and model training.
- [**Replit**](https://replit.com/) – Browser-based coding environment for rapid prototyping and collaboration.
- [**GitHub**](https://github.com/) – Manage code, track changes, and collaborate with your team easily.

---

## 📊 Data Sources

- [**Kaggle Datasets**](https://www.kaggle.com/datasets) – Thousands of public datasets across domains, including energy and sustainability.
- **UCI Machine Learning Repository** – Classic datasets for experimentation and analysis.
- [**Google Dataset Search**](https://datasetsearch.research.google.com/) – Find open datasets from universities, governments, and organisations.
